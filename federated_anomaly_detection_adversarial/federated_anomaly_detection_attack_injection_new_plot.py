...
if __name__ == "__main__":
    ...
    for pi_to_inject in pis_to_inject:
        ...
        for agg in AggregationMechanism:
            ...
            # TODO: save dataframe instead of models -> saves way more time
    ...
    fig.legend(handles, labels, bbox_to_anchor=(1, 0.9), title="# of Adversaries")
    fig.tight_layout()
    plt.show()
    fig.savefig(f'result_plot_homogeneous_anomaly_detection_inj_all_test.png', dpi=100)
